 ...
 *
 * Power suspend/resume helpers adapted from GBA-Rush-PSP
 * (https://github.com/redcode9/GBA-Rush-PSP, Piero Carrieri)
 * so gameplay sleep/resume does not do file I/O on the power callback thread.
 *
